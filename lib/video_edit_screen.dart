...
import 'package:mav/crop_page.dart';
import 'package:mav/export_service.dart';
import 'package:mav/widgets/export_result.dart';
...
//           builder: (BuildContext context) => VideoEditor(file: File(file.path), url: '',),
//         ),
//       );
//     }
//   }
...
class VideoEditor extends StatefulWidget {
  const VideoEditor({super.key, required this.file,required this.url,required this.parameters});
  ...
  void _exportVideo() async {
    ...
    await ExportService.runFFmpegCommand(
      ...
      onCompleted: (file) {
        ...
        showDialog(
          context: context,
          builder: (_) => VideoResultPopup(video: file,url:widget.url,parameters:widget.parameters),
        );
      },
    );
  }

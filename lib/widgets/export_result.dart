...
import 'package:mav/video_player_screen.dart';
...
class VideoResultPopup extends StatefulWidget {
  const VideoResultPopup({super.key, required this.video,required this.url,required this.parameters});
  final String url;
  final File video;
              ...
              child: Column(
                children: [
                  FileDescription(
                    ...
                    print("hi");
                    Navigator.pushReplacement (context, MaterialPageRoute(builder: (context)=>MultipleVideosDemo(path1: widget.video.path,url: widget.url,parameters: widget.parameters,)));
